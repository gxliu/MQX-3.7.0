...
LDD_TError PWM_ConnectPin(LDD_TDeviceData *DeviceDataPtr, LDD_TPinMask PinMask)
{
  ...
  /* Pin mask test - this test can be disabled by setting the "Ignore range checking"
     property to the "yes" value in the "Configuration inspector" */
  if ((PinMask & ((LDD_TPinMask)~AVAILABLE_PIN_MASK)) != 0U) {
    return ERR_PARAM_MASK;
  }
  if ((PinMask & PWM_CHANNEL_0_PIN) != 0U) {
    clrSetReg32Bits(PORTC_PCR1, 0x01000300U, 0x0400U); /* MUX=0x04U */
  }
  return ERR_OK;                       /* OK */
}
...
LDD_TDriverState PWM_GetDriverState(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  DriverState |= (FTM_PDD_GetEnableDeviceStatus(FTM0_BASE_PTR))? 0x00U : PE_LDD_DRIVER_DISABLED_BY_USER; /* Driver disabled by the user? */
  return DriverState;
}
