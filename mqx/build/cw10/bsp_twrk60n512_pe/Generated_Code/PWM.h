...
**     Version   : Component 01.121, Driver 01.02, CPU db: 3.00.001
**     Compiler  : CodeWarrior ARM C Compiler
**     Date/Time : 2011-03-28, 21:40, # CodeGen: 53
**     Abstract  :
...
**                  Initial state                          : Low
**                  Output pin                             : PTC1/SPI0_PCS3/UART1_RTS_b/FTM0_CH0/FB_AD13/ADC0_SE15/TSI0_CH14
**                  Output pin signal                      : 
**                Interrupt                                : Disabled
**          Initialization                                 : 
...
**         ConnectPin            - LDD_TError PWM_ConnectPin(LDD_TDeviceData *DeviceDataPtr, LDD_TPinMask PinMask);
**         SetOperationMode      - LDD_TError PWM_SetOperationMode(LDD_TDeviceData *DeviceDataPtr,...
...
#endif
#define PWM_CNT_INP_FREQ_U_0 0x02DC6C00UL /* Counter input frequency in Hz */
#define PWM_CNT_INP_FREQ_R_0 48000768.0122881966F /* Counter input frequency in Hz */
...
#define PWM_CLOCK_PIN      0x01U       /* Counter input clock pin mask */
#define PWM_CHANNEL_0_PIN  0x02U       /* Channel 0 pin mask */
#define PWM_CHANNEL_1_PIN  0x04U       /* Channel 1 pin mask */
#define PWM_CHANNEL_2_PIN  0x08U       /* Channel 2 pin mask */
#define PWM_CHANNEL_3_PIN  0x10U       /* Channel 3 pin mask */
#define PWM_CHANNEL_4_PIN  0x20U       /* Channel 4 pin mask */
#define PWM_CHANNEL_5_PIN  0x40U       /* Channel 5 pin mask */
#define PWM_CHANNEL_6_PIN  0x80U       /* Channel 6 pin mask */
#define PWM_CHANNEL_7_PIN  0x0100U     /* Channel 7 pin mask */
...
#define PWM_ConnectPin_METHOD_ENABLED
#define PWM_SetOperationMode_METHOD_ENABLED
...
LDD_TError PWM_ConnectPin(LDD_TDeviceData *DeviceDataPtr, LDD_TPinMask PinMask);
/*
** ===================================================================
**     Method      :  PWM_ConnectPin (component TimerUnit_LDD)
**
**     Description :
...
**         support runtime pin sharing with other internal on-chip
**         peripherals.
**     Parameters  :
**         NAME            - DESCRIPTION
**       * DeviceDataPtr   - Device data structure
...
**                           to this mask.
**                           Possible parameters:
**                           Component_CLOCK_PIN   - Counter input clock
**                           pin
**                           Component_CHANNEL_n_PIN   - Channel n pin
**     Returns     :
**         ---             - Error code, possible codes:
**                           ERR_OK - OK
**                           ERR_SPEED - The component does not work in
**                           the active clock configuration
**                           ERR_PARAM_MASK - Pin mask is not valid
** ===================================================================
*/

LDD_TError PWM_SetOperationMode(LDD_TDeviceData *DeviceDataPtr, LDD_TDriverOperationMode OperationMode, LDD_TCallback ModeChangeCallback, LDD_TCallbackParam *ModeChangeCallbackParamPtr);
/*
** ===================================================================
**     Method      :  PWM_SetOperationMode (component TimerUnit_LDD)
**
**     Description :
