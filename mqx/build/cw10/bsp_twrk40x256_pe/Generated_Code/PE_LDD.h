...
#define PE_LDD_COMPONENT_TRG_ID                  0x02U
#define PE_LDD_COMPONENT_WDog1_ID                0x03U
#define PE_LDD_COMPONENT_PWM_ID                  0x04U
...
#define LDD_USB_ULPI_STOP_PIN              0x00400000u /* ULPI_STOP pin mask */
...
typedef enum {                                          /* Type specifying HW commands for a flash device */
  LDD_FLASH_READ_1S_BLOCK             = 0x00u,          /* Verify flash memory block it is erased */
...
typedef enum {
  LDD_ANALOGCOMP_RISING_EDGE_MODE = 0x0AU,
  LDD_ANALOGCOMP_FALLING_EDGE_MODE = 0x08U,
  LDD_ANALOGCOMP_BOTH_EDGES_MODE = 0x12U
...
typedef enum {                                                    /* Type specifying the DMA transfer mode. */
  LDD_DMA_CYCLE_STEAL,                                            /* Only single read/write transfer is done per one service request. */
...
typedef struct {                                                  /* Type specifying the DMA Transfer descriptor information structure. */
  ...
  LDD_DMA_TByteCount             ByteCount;                       /* Size of data in bytes to be transfered in single transfer. */
...
#define LDD_RTC_ON_STOPWATCH      0x01u /* OnStopwatch event mask */
#define LDD_RTC_ON_TIME_OVERFLOW  0x0100u /* OnTimeOverflow event mask */
#define LDD_RTC_ON_TIME_INVALID   0x0101u /* OnTimeInvalid event mask */
...
#define LDD_ivIndex_INT_LCD                     0x66u
...
/*
** ===================================================================
**     Method      :  PE_PeripheralUsed (component MK40N512MD100)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  LDD_SetClockConfiguration (component MK40N512MD100)
**
**     Description :
