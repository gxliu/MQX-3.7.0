...
**     Component : GPIO_LDD
**     Version   : Component 01.119, Driver 01.01, CPU db: 3.00.001
**     Compiler  : CodeWarrior ARM C Compiler
**     Date/Time : 2011-03-17, 21:46, # CodeGen: 29
**     Abstract  :
...
**              Pins                                       : 1
**                Pin                                      : 
**                  Pin                                    : PTC9/I2S0_RX_BCLK/FTM2_FLT0/LCD_P29/ADC1_SE5b/CMP0_IN3
**                  Pin signal                             : LED_E1
...
**              Pins                                       : 1
**                Pin                                      : 
**                  Pin                                    : PTC8/I2S0_MCLK/I2S0_CLKIN/LCD_P28/ADC1_SE4b/CMP0_IN2
**                  Pin signal                             : LED_E2
**                  Initial pin direction                  : Output
**                    Initial output state                 : 1
**                  Initial pin event                      : Disabled
...
**              Pins                                       : 1
**                Pin                                      : 
**                  Pin                                    : PTC7/SPI0_SIN/LCD_P27/CMP0_IN1
**                  Pin signal                             : LED_E3
**                  Initial pin direction                  : Output
**                    Initial output state                 : 1
**                  Initial pin event                      : Disabled
...
#define GPIO1_ALLOCATED_PINS_MASK 0x0380U /* Mask of all allocated pins from the port */
...
#define GPIO1_FIELD_1_PIN_0 LDD_GPIO_PIN_8 /* Constant for the pin in the field used in the method ConnectPin */
...
#define GPIO1_LED2_START_BIT 8u        /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_LED2_MASK 0x0100u        /* Mask of the bits allocated by the bit field (within the port) */
#define GPIO1_LED3_START_BIT 7u        /* Index of the starting bit of the bit field (0 represents LSB) */
#define GPIO1_LED3_MASK 0x80u          /* Mask of the bits allocated by the bit field (within the port) */
