...
LDD_TDeviceData* GPIO1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* GPIOC_PDOR: PDO|=0x0380 */
  GPIOC_PDOR |= (uint32_t)0x0380UL;                       
  /* GPIOC_PDDR: PDD|=0x0380 */
  GPIOC_PDDR |= (uint32_t)0x0380UL;                       
  ...
  PORTC_PCR8 = (uint32_t)((PORTC_PCR8 & (uint32_t)~0x01008600UL) | (uint32_t)0x0100UL);
  /* PORTC_PCR7: ISF=0,LK=0,MUX=1 */
  PORTC_PCR7 = (uint32_t)((PORTC_PCR7 & (uint32_t)~0x01008600UL) | (uint32_t)0x0100UL);
...
void GPIO1_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  /* PORTC_PCR8: IRQC=0 */
  PORTC_PCR8 &= (uint32_t)~0x000F0000UL;                      
  /* PORTC_PCR7: IRQC=0 */
  PORTC_PCR7 &= (uint32_t)~0x000F0000UL;                      
  /* GPIOC_PDDR: PDD&=~0x0380 */
  GPIOC_PDDR &= (uint32_t)~0x0380UL;                      
...
LDD_TError GPIO1_ConnectPin(LDD_TDeviceData *DeviceDataPtr, LDD_TPinMask PinMask)
{
  ...
  if ((PinMask & LDD_GPIO_PIN_8) != 0U) {
    clrSetReg32Bits(PORTC_PCR8, 0x01000600U, 0x0100U); /* MUX=0x01U */
  }
