...
if not exist ..\..\..\..\mqx\build\cw10\bsp_twrk40x256\Generated_Code\PE_LDD.h goto gen_files_copy_skip
    rem Copy PE generated files to bsp\Generated_Code
    copy /Y ..\..\..\..\mqx\build\cw10\bsp_twrk40x256\Generated_Code\*.h .
    copy /Y ..\..\..\..\mqx\build\cw10\bsp_twrk40x256\Sources\*.h .
