...
if not exist ..\..\..\..\mqx\build\cw10\bsp_twrk60n512_pe\Generated_Code\PE_LDD.h goto gen_files_copy_skip
    rem Copy PE generated files to bsp\Generated_Code
    copy /Y ..\..\..\..\mqx\build\cw10\bsp_twrk60n512_pe\Generated_Code\*.h .
    copy /Y ..\..\..\..\mqx\build\cw10\bsp_twrk60n512_pe\Sources\*.h .
