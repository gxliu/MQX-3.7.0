...
#
    ...
    ".(data|bss)&mqx(_regabi)?(_d)?.a&mqx\\w*.o" => "CORE_RAM",
    ".(data|bss)&psp_\\w+.a&mqx\\w*.o"           => "CORE_RAM",
...
@PSP_ROM_COMPONENTS = (
    ...
    "IO_ROM", #"IO_RAM",
    "KLOG_ROM", #"KLOG_RAM",
    "LWEVENT_ROM", #"LWEVENT_RAM",
    "LWLOG_ROM", #"LWLOG_RAM",
    "LWMSG_ROM", #"LWMSG_RAM",
    "LWTIMER_ROM", #"LWTIMER_RAM",
    "LOG_ROM", #"LOG_RAM",
    "MSG_ROM", #"MSG_RAM",
    "MUTEX_ROM", #"MUTEX_RAM",
    "SEM_ROM", #"SEM_RAM",
...
(
    ...
    "MFS_DIR_ROM",#"DIR_RAM",
    "MFS_ATTRI_ROM",#"MFS_ATTRI_RAM",
    "MFS_CLUS_ROM",#"MFS_CLUS_RAM",
    "MFS_CRE_ROM",# "MFS_CRE_ROM",
    "MFS_DEL_ROM",#"MFS_DEL_RAM",
    
    "MFS_FAT_ROM",#"MFS_FAT_RAM", 
    "MFS_FORMA_ROM",#"MFS_FORMA_RAM",
    "MFS_HANDLE_ROM",#"MFS_HANDLE_RAM",
    "MFS_INIT_ROM",#"MFS_INIT_RAM", 
    "MFS_LFN_ROM",#"MFS_LFN_RAM",
    "MFS_RENAME_ROM",# "MFS_RENAME_RAM", 
    "MFS_MISC_ROM",#"MFS_MISC_RAM",
    "MFS_OPEN_ROM",#"MFS_OPEN_RAM", 
    "MFS_RW_ROM",#"MFS_RW_RAM", 
    "MFS_PARSE_ROM",#"MFS_PARSE_RAM", 
    "MFS_SEARCH_ROM",#"MFS_SEARCH_RAM", 
    "MFS_TIME_ROM",#"MFS_TIME_RAM", 
    "MFS_PMGR_ROM",#"MFS_PMGR_RAM",
...
(
    # HTTP server
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(httpd|httpd_mqx|httpd_supp)\\w*.o" => "RTCS_HTTPD_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(httpd|httpd_mqx|httpd_supp)\\w*.o"           => "RTCS_HTTPD_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(httpd|httpd_mqx|httpd_supp)\\w*.o" => "RTCS_HTTPD_RAM",
    ".(data|bss)&rtcs_\\w+.a&(httpd|httpd_mqx|httpd_supp)\\w*.o"           => "RTCS_HTTPD_RAM",
    
    # FTP
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(ftpclnt|ftpd_cmd|ftpd_msg)\\w*.o" => "RTCS_FTP_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(ftpclnt|ftpd_cmd|ftpd_msg)\\w*.o"           => "RTCS_FTP_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(ftpclnt|ftpd_cmd|ftpd_msg)\\w*.o" => "RTCS_FTP_RAM",
    ".(data|bss)&rtcs_\\w+.a&(ftpclnt|ftpd_cmd|ftpd_msg)\\w*.o"           => "RTCS_FTP_RAM",
    
    # TELNETD
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(telnet|telnetio|telnsrv)\\w*.o" => "RTCS_TELD_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(telnet|telnetio|telnsrv)\\w*.o"           => "RTCS_TELD_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(telnet|telnetio|telnsrv)\\w*.o" => "RTCS_TELD_RAM",
    ".(data|bss)&rtcs_\\w+.a&(telnet|telnetio|telnsrv)\\w*.o"           => "RTCS_TELD_RAM",
    
    # ECHO
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(echosrv)\\w*.o" => "RTCS_ECHO_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(echosrv)\\w*.o"           => "RTCS_ECHO_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(echosrv)\\w*.o" => "RTCS_ECHO_RAM",
    ".(data|bss)&rtcs_\\w+.a&(echosrv)\\w*.o"           => "RTCS_ECHO_RAM",
    
    # EDS
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&eds\\w*.o" => "RTCS_EDS_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&eds\\w*.o"           => "RTCS_EDS_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&eds\\w*.o" => "RTCS_EDS_RAM",
    ".(data|bss)&rtcs_\\w+.a&eds\\w*.o"           => "RTCS_EDS_RAM",
    
    #TFTP
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(loadtb|loadtc|loadts|tftp|tftpacc|tftpsrv|tftputil)\\w*.o" => "RTCS_TFTP_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(loadtb|loadtc|loadts|tftp|tftpacc|tftpsrv|tftputil)\\w*.o"           => "RTCS_TFTP_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(loadtb|loadtc|loadts|tftp|tftpacc|tftpsrv|tftputil)\\w*.o" => "RTCS_TFTP_RAM",
    ".(data|bss)&rtcs_\\w+.a&(loadtb|loadtc|loadts|tftp|tftpacc|tftpsrv|tftputil)\\w*.o"           => "RTCS_TFTP_RAM",
    
    #SOCKET
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(sockio|sdgram|sockutil|soip|sosel0|sosel1|soselset|sosock|sotcpsoudp|sstream)\\w*.o" => "RTCS_SOCK_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(sockio|sdgram|sockutil|soip|sosel0|sosel1|soselset|sosock|sotcpsoudp|sstream)\\w*.o"           => "RTCS_SOCK_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(sockio|sdgram|sockutil|soip|sosel0|sosel1|soselset|sosock|sotcpsoudp|sstream)\\w*.o" => "RTCS_SOCK_RAM",
    ".(data|bss)&rtcs_\\w+.a&(sockio|sdgram|sockutil|soip|sosel0|sosel1|soselset|sosock|sotcpsoudp|sstream)\\w*.o"           => "RTCS_SOCK_RAM",
    
    #DNS
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(dnsinit|resolver|dnsutil|ifdns|dnshosts)\\w*.o" => "RTCS_DNS_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(dnsinit|resolver|dnsutil|ifdns|dnshosts)\\w*.o"           => "RTCS_DNS_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(dnsinit|resolver|dnsutil|ifdns|dnshosts)\\w*.o" => "RTCS_DNS_RAM",
    ".(data|bss)&rtcs_\\w+.a&(dnsinit|resolver|dnsutil|ifdns|dnshosts)\\w*.o"           => "RTCS_DNS_RAM",
    
    #RTCS
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(ifadd|ifbootp|ifdhcp|ifrem|ifppp|rtcscmd|rtcs|select)\\w*.o" => "RTCS_RTCS1_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(ifadd|ifbootp|ifdhcp|ifrem|ifppp|rtcscmd|rtcs|select)\\w*.o"           => "RTCS_RTCS1_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(ifadd|ifbootp|ifdhcp|ifrem|ifppp|rtcscmd|rtcs|select)\\w*.o" => "RTCS_RTCS1_RAM",
    ".(data|bss)&rtcs_\\w+.a&(ifadd|ifbootp|ifdhcp|ifrem|ifppp|rtcscmd|rtcs|select)\\w*.o"           => "RTCS_RTCS1_RAM",
    ...
    #ARP
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(arp|arpinit|proxyarp)\\w*.o" => "RTCS_ARP_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(arp|arpinit|proxyarp)\\w*.o"           => "RTCS_ARP_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(arp|arpinit|proxyarp)\\w*.o" => "RTCS_ARP_RAM",
    ".(data|bss)&rtcs_\\w+.a&(arp|arpinit|proxyarp)\\w*.o"           => "RTCS_ARP_RAM",
    
    #IP
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(ipcfg|ipcp|ip-e|ip|ip_reasm|ipif_add|ipif_rem|iplocal|iproute|iputil|checksum)\\w*.o" => "RTCS_IP_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(ipcfg|ipcp|ip-e|ip|ip_reasm|ipif_add|ipif_rem|iplocal|iproute|iputil|checksum)\\w*.o"           => "RTCS_IP_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(ipcfg|ipcp|ip-e|ip|ip_reasm|ipif_add|ipif_rem|iplocal|iproute|iputil|checksum)\\w*.o" => "RTCS_IP_RAM",
    ".(data|bss)&rtcs_\\w+.a&(ipcfg|ipcp|ip-e|ip|ip_reasm|ipif_add|ipif_rem|iplocal|iproute|iputil|checksum)\\w*.o"           => "RTCS_IP_RAM",
    ...
    #DHCP
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(dhcpclnt|dhcputil)\\w*.o" => "RTCS_DHCP_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(dhcpclnt|dhcputil)\\w*.o"           => "RTCS_DHCP_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(dhcpclnt|dhcputil)\\w*.o" => "RTCS_DHCP_RAM",
    ".(data|bss)&rtcs_\\w+.a&(dhcpclnt|dhcputil)\\w*.o"           => "RTCS_DHCP_RAM",
    
    #ICMP
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(icmp|ping)\\w*.o" => "RTCS_ICMP_ROM",
    ".(text|rodata|data)&rtcs_\\w+.a&(icmp|ping)\\w*.o"           => "RTCS_ICMP_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(icmp|ping)\\w*.o" => "RTCS_ICMP_RAM",
    ".(data|bss)&rtcs_\\w+.a&(icmp|ping)\\w*.o"           => "RTCS_ICMP_RAM",
...
(
    ...
    "RTCS_RTCS1_ROM"      => "RTCS Core Code",
    "RTCS_RTCS1_RAM"      => "RTCS Core Global Data",
    ...
    "RTCS_DHCP_ROM"       => "DHCP Code",
    "RTCS_DHCP_RAM"       => "DHCP Global Data",
...
sub save_html
{
    ...
    $t .= "<BR>(c) 2009-2011 Freescale Semiconductor. All rights reserved.\r\n";
        ...
        elsif($format eq "iararm")
        {
            ...
            elsif($iar_part eq "E")
            {
                if($line =~ /^\s*([A-Za-z_][.A-Za-z0-9_]*)?\s+(0x\w+)\s+(0x(\w+))?\s+(Code|Data)\s+\w+\s+([.A-Za-z0-9_]+)\s+\[(\d+)\]\s*$/)
                {
                    ...
                    $sect = iar_get_sect($2, $3);
                    $objfile = $6;
                    @objfiles = ($objfile, $iar_modules{$7});
...
#                    $zerosz_addr = $symsz ? "" : $addr;
        ...
        foreach $mrall (keys %map)
        {
            ...
            if($match)
            {
                ...
                foreach $f (@friendlynames)
                {
                    ...
                    {
                        $used{$f} = 1;
                        push @sym_in_components,$f if "@ALL_COMPONENTS" =~ /\b$f\b/;
                    }
                }
            }
        }
        ...
        if($DUMP_SYM_DETAILS and %used)
        {
            print "Symbol $symbol (size=$symsz) is mapped to:\n";
        }
...
sub print_usage
{
    my $readme = 
        ...
        "\nFreescale Semiconductor MQX(TM) MAP-file analyzer/CodeSize script v3.7\n".
